...
@section('detail')
                                    ...
                                    <div class="media mt-3 parents-share-media">
                                        ...
                                        <div class="media-body">
                                            <h5 class="mt-0 monkey-f-bold monkey-fz-15">
                                                <a class="cursor"
                                                   href="https://www.monkey.edu.vn/ba-me-can-biet/hoc-lieu-bo-tro-hieu-qua-hoc-tieng-anh-tai-nha-tren-monkey-stories.html">Học
                                                    liệu bổ trợ hiệu quả học tiếng Anh tại nhà trên Monkey Stories</a>
                                ...
                                <div class="pb-3 pb-lg-4 border-bottom mt-3 mt-lg-4">
                                    <div class="media mt-3 parents-share-media">
                                        ...
                                        <div class="media-body">
                                            <h5 class="mt-0 monkey-f-bold monkey-fz-15">
                                                <a class="cursor"
                                                   href="https://www.monkey.edu.vn/ba-me-can-biet/thanh-toan-goi-hoc-monkey-junior-qua-tai-khoan-mobifone.html">Thanh
                                                    toán gói học Monkey Junior qua tài khoản Mobifone</a>
                                                ...
                                                <div class="student-documents-content">
                                                    <p class="mb-3">
                                                        <a href="https://www.monkey.edu.vn//hoc-lieu/cung-con-hoc-50-tu-vung-tieng-anh-qua-mind-map-chu-de-clothing.html"
                                                           class="btn monkey-color-gray monkey-bc-gray hvr-icon-registration-white not-active">
                                                    ...
                                                    <p class="mb-3">
                                                        <a style="display: inline;"
                                                           href="https://www.monkey.edu.vn//hoc-lieu/cung-con-hoc-50-tu-vung-tieng-anh-qua-mind-map-chu-de-clothing.html"
                                                           class="btn monkey-color-white monkey-bg-green hvr-icon-registration distance-center">
    ...
    grid-template-columns: repeat(2, 1fr);grid-gap: 0.5rem; border-bottom: 1px solid #ddd;padding-bottom: 10px;">
                                                ...
                                                <div class="student-documents-content">
                                                    ...
                                                    <p class="mb-3">
                                                        <a style="display: inline;"
                                                           href="https://www.monkey.edu.vn//hoc-lieu/cung-con-hoc-voi-hoc-lieu-vong-quay-40-tu-vung-chu-de-job.html"
                                                           class="btn monkey-color-white monkey-bg-green hvr-icon-registration distance-center">
                                                            <span class="monkey-fz-15">Xem thêm</span></a>
                                                    </p>
                                                </div>
    ...
    grid-template-columns: repeat(2, 1fr);grid-gap: 0.5rem; border-bottom: 1px solid #ddd;padding-bottom: 10px;">
                                                ...
                                                <div class="student-documents-content">
                                                    ...
                                                    <p class="mb-3">
                                                        <a style="display: inline;"
                                                           href="https://www.monkey.edu.vn//hoc-lieu/cung-con-hoc-voi-hoc-lieu-mindmap-chu-de-school.html"
                                                           class="btn monkey-color-white monkey-bg-green hvr-icon-registration distance-center">
                                                            <span class="monkey-fz-15">Xem thêm</span></a>
                                                    </p>
                                                </div>
