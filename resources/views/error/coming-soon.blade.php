...
<head>
    ...
    <!-- CSS
    ================================================== -->
    <link rel="stylesheet" href="{{URL::asset('/bonus/css/styles.css') }}">
    <link rel="stylesheet" href="{{URL::asset('/bonus/css/vendor.css') }}">
...
<div class="s-pagewrap">
    ...
    <header class="s-header">
        <div class="row s-header__content">
            ...
            <div class="s-header__logo">
                <a class="logo" href="/">
                    <img src="{{URL::asset('/images/logo-ek-title.png') }}" alt="Homepage">
                </a>
            </div>
    ...
    <!-- # info
    ================================================== -->
    <section id="info" style="display: none" class="s-info">
                ...
                <div class="tab-content">
                    ...
                    <div id="tab-services" class='tab-content__item'>
                        ...
                        <div class="row">
                            <div class="column">
                                <p class="lead">
                                    Sit ut cum molestiae. Dolore ducimus qui quasi. Fugiat consequatur sit vel illum vel
                                    et
                        ...
                        <div class="row services-list block-lg-one-half block-md-one-half block-tab-whole">
                            ...
                            <div class="column services-list__item">
                                <div class="services-list__item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                         style="fill:rgba(0, 0, 0, 1);transform:;-ms-filter:">
                                        <path d="M20,3H4C2.897,3,2,3.897,2,5v11c0,1.103,0.897,2,2,2h4l-1.8,2.4l1.6,1.2l2.7-3.6h3l2.7,3.6l1.6-1.2L16,18h4 c1.103,0,2-0.897,2-2V5C22,3.897,21.103,3,20,3z M4,16V5h16l0.001,11H4z"></path>
...
<script src="{{URL::asset('/bonus/js/main.js') }}"></script>
<script src="{{URL::asset('/bonus/js/particles.min.js') }}"></script>
<script src="{{URL::asset('/bonus/particle-settings.js') }}"></script>
