...
<head>
    ...
    <style>
        * {
        ...
        body {
            background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgRiNqTV6QK7TNyo-MP6eJeWLA0B4S9KvKOw&usqp=CAU');
...
<div class="container col-8">
    <div class="row">
        <div class="col-lg-12" style="font-size: 30px;text-align: center" id="question">What is
            the {{$main-> values}}</div>
