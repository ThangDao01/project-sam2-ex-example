        ...
        <div class="panel-body">
            <form class="form-horizontal bucket-form" action="/admin/data-support/edit" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" placeholder="Enter voice_vi" name="words" value="{{$obj->words}}">
                        @error ('words')
                        <div class="text-danger">* {{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="in-color" placeholder="Enter color" name="color" value="{{$obj->color}}">
                        @error ('color')
                        <div class="text-danger">* {{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="video" id="in-video" value="{{$obj->video}}">
                        @error ('video')
                        <div class="text-danger">* {{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="voice" id="in-voice" value="{{$obj->voice}}">
                ...
                <div class=" form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="in-images" name="images" value="{{$obj->images}}" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <img id="demo-img" src="{{$obj->images}}" width="100px" alt="">
                        <p id="demo-color" style="width: 100px;height: 100px;background-color: {{$obj->color}};float: left"></p>
                        <audio controls style="width: 100px;" id="demo-voice">
                            <source  src="{{$obj->voice}}" type="audio/ogg">
                        </audio>
                        <iframe id="demo-video" width="200" height="100" src="https://www.youtube.com/embed/{{$obj->video}}"
